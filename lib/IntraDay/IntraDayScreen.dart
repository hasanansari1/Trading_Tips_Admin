...
class IntraDayScreen extends StatefulWidget {
  ...
  @override
  _IntraDayScreenState createState() => _IntraDayScreenState();
}
...
class _IntraDayScreenState extends State<IntraDayScreen> {
  ...
  Future<void> navigateToEditScreen(String documentId) async {
    await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => EditIntraDayScreen(documentId: documentId),
      ),
    );
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          List<IntraDayModel> intraDayData = snapshot.data!.docs.map((doc) {
            return IntraDayModel.fromSnapshot(doc);
          }).toList();
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              IntraDayModel data = intraDayData[index];
